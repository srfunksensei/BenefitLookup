package rs.co.pamet.android.benefit_lookup.content_providers;

import rs.co.pamet.android.benefit_lookup.database.BenefitsDatabese;
...
public class SearchContentProvider extends ContentProvider {
	...
	public static String AUTHORITY = "rs.co.pamet.android.benefit_lookup.content_providers.SearchContentProvider";
	public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY
			+ "/" + SearchManager.SUGGEST_URI_PATH_QUERY);

	// MIME types used for searching words or looking up a single definition
	public static final String CATEGORY_MIME_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE
			+ "/rs.co.pamet.android.benefit_lookup.content_providers.searchcontentprovider";
	public static final String SUBCATEGORY_MIME_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE
			+ "/rs.co.pamet.android.benefit_lookup.content_providers.searchcontentprovider";

	private BenefitsDatabese mBenefits;

	// UriMatcher stuff
	private static final int SEARCH_SUBCATEGORIES = 0;
	private static final int GET_SUBCATEGORY = 1;
	...
	private static UriMatcher buildUriMatcher() {
		...
		// to get definitions...
		matcher.addURI(AUTHORITY, "benefits", SEARCH_SUBCATEGORIES);
		matcher.addURI(AUTHORITY, "benefits/#", GET_SUBCATEGORY);
		// to get suggestions...
	...
	public boolean onCreate() {
		mBenefits = new BenefitsDatabese(getContext());
		return true;
	}
	...
	private Cursor getSuggestions(String query) {
		...
		String[] columns = new String[] { BaseColumns._ID,
				BenefitsDatabese.BENEFITS_TABLE_CATEGORY_COLUMN,
				BenefitsDatabese.BENEFITS_TABLE_SUBCATEGORY_COLUMN,
				SearchManager.SUGGEST_COLUMN_SHORTCUT_ID,

				SearchManager.SUGGEST_COLUMN_INTENT_DATA_ID };

		return mBenefits.getSubCategoryLike(query, columns);
	}
	...
	private Cursor getRow(Uri uri) {
		String rowId = uri.getLastPathSegment();
		String[] columns = new String[] {
				BenefitsDatabese.BENEFITS_TABLE_CATEGORY_COLUMN,
				BenefitsDatabese.BENEFITS_TABLE_SUBCATEGORY_COLUMN, };

		return mBenefits.getRow(rowId, columns);
	}
