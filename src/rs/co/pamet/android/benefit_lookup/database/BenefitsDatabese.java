...
public class BenefitsDatabese {

	// The columns we'll include in the dictionary table
	public static final String BENEFITS_TABLE_CATEGORY_COLUMN = "CATEGORY";
	public static final String BENEFITS_TABLE_SUBCATEGORY_COLUMN = "SUBCATEGORY";

	private final BenefitDatabaseHelper benefitsHelper;
	 ...
	 */
	public BenefitsDatabese(Context context) {
		benefitsHelper = new BenefitDatabaseHelper(context);
	}
	...
	private static HashMap<String, String> buildColumnMap() {
		...
		map.put(BENEFITS_TABLE_CATEGORY_COLUMN, BENEFITS_TABLE_CATEGORY_COLUMN
				+ " AS " + SearchManager.SUGGEST_COLUMN_TEXT_2);
		map.put(BENEFITS_TABLE_SUBCATEGORY_COLUMN,
				BENEFITS_TABLE_SUBCATEGORY_COLUMN + " AS "
	 ...
	 */
	public Cursor getRow(String rowId, String[] columns) {
	 ...
	 */
	public Cursor getCategoryLike(String query, String[] columns) {
		String selection = BENEFITS_TABLE_CATEGORY_COLUMN + " LIKE ?";
		...
		/*
		 * This builds a query that looks like: SELECT <columns> FROM <table>
		 * WHERE <KEY_WORD> LIKE 'query*' which is an FTS3 search for the query
	...
	public Cursor getSubCategoryLike(String query, String[] columns) {
		String selection = BENEFITS_TABLE_SUBCATEGORY_COLUMN + " LIKE ?";
		String[] selectionArgs = new String[] { "%" + query + "%" };
	...
	private Cursor query(String selection, String[] selectionArgs,
		...
		builder.setTables(BenefitDatabaseHelper.BENEFITS_TABLE_NAME);
		builder.setProjectionMap(mColumnMap);

		Cursor cursor = builder.query(benefitsHelper.getReadableDatabase(),
