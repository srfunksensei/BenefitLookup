...
public abstract class AbstractCoverFlowImageAdapter extends BaseAdapter {
	 ...
	 */
	public abstract String getCategoryName(int position);
	 ...
	 */
	public abstract String[] getSubcategoryList(int position);
	...
	public final synchronized ImageView getView(final int position,
		...
		if (convertView == null) {
			...
			imageView.setBackgroundResource(R.drawable.shape_img_item_back);
